...
/**
 * Settings form for the summarise_text action.
 *
 * Adds the word cap, which earlier releases hard-coded at 500 words and applied
 ...
 */
class action_summarise_text_form extends action_form {
    #[\Override]
